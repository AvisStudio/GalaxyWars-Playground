...
public enum ParticleEffect {
     ...
     * </ul>
     */
    EXPLOSION_NORMAL("explode", 0, -1, "Big White Smoke", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    EXPLOSION_LARGE("largeexplode", 1, -1, "Explosion"),
    /**
     * A particle effect which is displayed by exploding tnt and creepers:
     * <ul>
     ...
     * </ul>
     */
    EXPLOSION_HUGE("hugeexplosion", 2, -1, "Huge Explosion"),
    /**
     ...
     * </ul>
     */
    FIREWORKS_SPARK("fireworksSpark", 3, -1, "Firework Spark", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    WATER_SPLASH("splash", 5, -1, "Water Splash", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    CRIT("crit", 9, -1, "Brown Magic", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    CRIT_MAGIC("magicCrit", 10, -1, "Magic Crit", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SMOKE_LARGE("largesmoke", 12, -1, "Black Smoke", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SPELL_MOB("mobSpell", 15, -1, "Black Swirls", ParticleProperty.COLORABLE),
    /**
     * A particle effect which is displayed by entities with active potion
     ...
     * </ul>
     */
    SPELL_MOB_AMBIENT("mobSpellAmbient", 16, -1, "Transparent Black Swirls", ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    SPELL_WITCH("witchMagic", 17, -1, "Purple Magic"),
    /**
     ...
     * </ul>
     */
    DRIP_WATER("dripWater", 18, -1, "Water Drip"),
    /**
     ...
     * </ul>
     */
    DRIP_LAVA("dripLava", 19, -1, "Lava Drip"),
    /**
     ...
     * </ul>
     */
    VILLAGER_ANGRY("angryVillager", 20, -1, "Lightning Cloud"),
    /**
     ...
     * </ul>
     */
    VILLAGER_HAPPY("happyVillager", 21, -1, "Emerald Sparkle", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    TOWN_AURA("townaura", 22, -1, "Black Specks", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    NOTE("note", 23, -1, "Musical Note", ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    PORTAL("portal", 24, -1, "Portal Effect", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    ENCHANTMENT_TABLE("enchantmenttable", 25, -1, "Enchantment Words", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    FLAME("flame", 26, -1, "Flame", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    FOOTSTEP("footstep", 28, -1, "Foot Step"),
    /**
     ...
     * </ul>
     */
    CLOUD("cloud", 29, -1, "White Smoke", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    REDSTONE("reddust", 30, -1, "Red Smoke", ParticleProperty.COLORABLE),
    /**
     ...
     * </ul>
     */
    SNOW_SHOVEL("snowshovel", 32, -1, "Snow Puffs", ParticleProperty.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SLIME("slime", 33, -1, "Slime Particles"),
    /**
     ...
     * @param properties      Properties of this particle effect
     */
    ParticleEffect(String name, int id, int requiredVersion, String friendlyName, ParticleProperty... properties) {
        this.name = name;
        this.id = id;
        this.requiredVersion = requiredVersion;
        this.friendlyName = friendlyName;
        this.properties = Arrays.asList(properties);
        this.friendlyData = true;
    }

    public static ParticleEffect GetFromFriendlyName(String name) {
    ...
    public void display(Location center, float offsetX, float offsetY, float offsetZ, float speed, int amount) {
        display(offsetX, offsetY, offsetZ, speed, amount, center, 300);
    }

    public void display(Location center, float offsetX, float offsetY, float offsetZ, float speed, int amount, List<Player> players) {
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                Class<?> packetClass = ReflectionHandler.PackageType.MINECRAFT_SERVER.getClass("PacketPlayOutWorldParticles");
                packetConstructor = ReflectionHandler.getConstructor(packetClass);
                getHandle = ReflectionHandler.getMethod("CraftPlayer", ReflectionHandler.PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (data != null) {
                    ...
                    ReflectionHandler.setValue(packet, true, "k", effect == ParticleEffect.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                }
